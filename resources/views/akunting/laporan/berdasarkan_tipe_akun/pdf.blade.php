...
<div class="invoice">
  ...
  <table style="width: 100%; border-collapse: collapse;">
    <tbody>
      <tr>
          <td style="text-align: center; border: 1px solid;" colspan="4">{{$akun->first()->tipeAkun->nama_tipe}}</td>
      </tr>
      <tr>
        <td style="text-align: center; border: 1px solid;" width="81">Tanggal</td>
      ...
      ?>
      <tr>
       <td style="border: 1px solid; text-align:center;">{{date('d-M-Y', strtotime($akun->created_at))}}</td>
       <td style="border: 1px solid;">{{$akun->nama_akun}}</td>
...
<div class="invoice">
  <div class="invoice-right">
    <a href="#" class="btn btn-primary btn-icon icon-left hidden-print">
      Export Excel

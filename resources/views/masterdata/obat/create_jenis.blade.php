	...
	<div class="form-group row">
			<div class="col-md-12">
				...
				<div class="col-sm-3" style="margin-left: -78px; margin-right: 55px;">
					<input class="form-control" name="name" type="text" placeholder="kode jenis" required value="{{$kd_jenis}}" />
				</div>
				...
				<div class="col-sm-3" style="margin-left: -78px; margin-right: 14px;">
					<input class="form-control" name="name" type="text" placeholder="nama jenis obat" required/>
				</div>

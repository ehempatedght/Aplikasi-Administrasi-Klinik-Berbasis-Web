...
<ol class="breadcrumb bc-3">
	<li>
		<a href="{{ route('jenisobat.index') }}"><i class="entypo-home"> Daftar Jenis Obat</i></a>
	</li>
	<li class="active">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-sm-5">
									<select name="jenis_obat_id[0]" class="selectboxit" id="list" required>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-sm-5">
										<select name="satuan[0]" class="selectboxit">
...
<script>
	...
	$(document).ready(function() {
		$('#tambah_obat').click(function(e) {
			...
			'<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Pilih Jenis</label>'+
			'<div class="col-sm-5">'+
			'<select name="jenis_obat_id['+loop+']" class="form-control" id="list">' +
			'<option selected="selected" disabled value="Pilih">Pilih Jenis</option>' +
			'@foreach ($jenis_obats as $jenis_obat)' +
			'<option value="{{$jenis_obat->id}}">{{$jenis_obat->name}}</option>' +
			'@endforeach' +
			...
			'<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Nama Obat/Barang</label>' +
			'<div class="col-sm-5">' +
			'<input type="text" class="form-control" name="nama_obat['+loop+']" placeholder="nama obat barang" required>' +
			'</div>' +
			'</div>' +
			'<div class="form-group">' +
			'<div class="row">' +
			...
			'<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Deskripsi</label>' +
			'<div class="col-sm-5">' +
			'<textarea name="deskripsi['+loop+']" class="form-control" placeholder="deskripsi"></textarea>' +
			'</div>' +
			'</div>' +
			'</div>' +
			'</div>' +

			...
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('masterdata.pasien.datapasien.update', $pasien->id) }}" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" class="form-control datepicker" data-format="yyyy-mm-dd" name="created_at" value="{{date('Y-m-d', strtotime($pasien->created_at))}}" placeholder="tanggal registrasi">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" class="form-control datepicker" name="TanggalLahir" id="datepicker" data-format="dd MM yyyy" placeholder="tanggal lahir" value="{{date("d M Y", strtotime($pasien->TanggalLahir)) }}">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-sm-5">
									<select name="id_kota" class="select2">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-sm-5">
									<select name="id_kec" class="select2">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-sm-5">
									<select name="id_kel" class="select2">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numberValidation" name="no_kk" placeholder="nomor kartu keluarga" value="{{$pasien->no_kk}}">
						</div>
					</div>

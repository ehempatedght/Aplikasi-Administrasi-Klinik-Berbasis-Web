				...
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('pengeluaran.operasional.save') }}" method="post">
					...
					<div id="ket_1">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control numbers jumlah" id="jumlah_1" name="jumlah[]" placeholder="jumlah" value="0" autocomplete="off" onkeyup="hitung_total()" required />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea id="keterangan_1" name="keterangan[]"  placeholder="keterangan" class="form-control"></textarea>
							</div>
						</div>
					</div>

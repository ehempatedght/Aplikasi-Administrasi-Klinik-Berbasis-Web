			...
			<div class="panel-body">
				<form role="form" class="form-horizontal" action="{{ route('pengeluaran.honor.update', $honor->id) }}" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" class="form-control datepicker" name="tgl" data-format="dd MM yyyy" placeholder="tanggal" value="{{date("d M Y", strtotime($honor->tgl)) }}">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numbers" id="jumlah" name="jumlah" placeholder="jumlah" value="{{ $honor->jumlah }}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="jam" name="jam" placeholder="example: 2 jam" value="{{ $honor->jam }}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numbers" id="total" name="total" placeholder="total" value="{{ $honor->total }}" required />
						</div>
					</div>

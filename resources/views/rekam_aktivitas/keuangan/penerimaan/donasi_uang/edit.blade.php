	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('perekaman_aktivitas.keuangan.penerimaan.donasi_uang.update', $donasi_uang->id) }}" method="post">
					{{ csrf_field() }}
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Nama Donatur</label>
						
						<div class="col-sm-5">
							<input type="text" class="form-control" id="nama_donatur" name="nama_donatur" placeholder="nama donatur" value="{{$donasi_uang->nama_donatur}}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="cp" name="cp" placeholder="contact person" value="{{$donasi_uang->cp}}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numberValidation" id="hp" name="hp" placeholder="nomor hp" value="{{$donasi_uang->hp}}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numbers" id="jml_donasi" name="jml_donasi" placeholder="jumlah donasi" value="{{$donasi_uang->jml_donasi}}" required />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea name="keterangan" id="keterangan" class="form-control" placeholder="keterangan">{{$donasi_uang->keterangan}}</textarea>
						</div>
					</div>

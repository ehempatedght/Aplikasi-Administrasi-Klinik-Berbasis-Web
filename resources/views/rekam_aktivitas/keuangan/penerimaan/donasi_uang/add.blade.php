	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('perekaman_aktivitas.keuangan.penerimaan.donasi_uang.save') }}" method="post">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control numbers" id="jml_donasi" name="jml_donasi" placeholder="jumlah donasi" value="0" required />
						</div>
					</div>

...
<ol class="breadcrumb bc-3">
	...
	<li class="active">
		<strong>Edit Pemberian Obat</strong>
	</li>
</ol>
@if (count($errors) > 0)
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('medis.pemberian.update', $pemberian->id) }}" method="post">
					{{ csrf_field() }}
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Tanggal</label>
						<div class="col-sm-5">
							<div class="input-group">
								<input type="text" class="form-control datepicker" name="tgl" data-format="dd MM yyyy" placeholder="tanggal" required="" value="{{ date("d M Y", strtotime($pemberian->tgl)) }}">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="no_pend" name="no_pend" placeholder="nomor pendaftaran" value="{{$pemberian->no_pend}}" required readonly/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="hidden" name="jenis_id" id="jenis_id" value="{{$pemberian->jenis_id}}">
						<div class="col-sm-5">
							<input type="text" class="form-control" id="jenis" name="jenis" placeholder="jenis obat" value="{{$pemberian->obat->jenis_obat->jns_obt}}" required readonly/>
						</div>
					...
					<div class="form-group">
						...
						<input type="hidden" name="obat_id" id="obat_id" value="{{$pemberian->obat_id}}">
						<div class="col-sm-5">
							<input type="text" class="form-control" id="obat" name="obat" placeholder="nama obat" value="{{$pemberian->obat->nama_obat}}" required readonly/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="harga" value="{{$pemberian->jumlah}}" autocomplete="off" required />
							</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control" name="keterangan" placeholder="keterangan">{{$pemberian->keterangan}}</textarea>
						</div>
					</div>

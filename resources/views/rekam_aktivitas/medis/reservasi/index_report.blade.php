...
<div class="row">
    <h2 align="center">Laporan Data Reservasi</h2>
    <br />
    <br />
@if(session('message'))
...
<div class="row">
    <form role="form" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label">Poli :</label>
            <div class="col-sm-6">
                <select class="form-control select2 poli" name="poli" id="poli" required>
        ...
        <div class="form-group">
            <label for="field-1" class="col-sm-3 control-label">Dokter :</label>
            <div class="col-sm-6">
                <select class="form-control select2 dokter" name="dokter" id="dokter" required>
                        <option value="all">Semua</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#print').click(function() {
            ...
            window.location.href = home_url + '/laporan/pasien/reservasi/' + tanggal_awal + '/' + tanggal_akhir + '/' + poli + '/' + dokter +'/pdf';
        });
    });
</script>
@endsection
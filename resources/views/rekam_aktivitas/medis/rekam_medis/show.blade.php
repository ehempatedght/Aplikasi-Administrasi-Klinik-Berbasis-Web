				...
				<form role="form" class="form-horizontal form-groups-bordered" action="{{ route('rekam_medis.save') }}" method="post">
					{{ csrf_field() }}
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="rmdiagnosa" name="rmdiagnosa" placeholder="diagnosa penyakit" value="{{$rekam->rmdiagnosa}}" required readonly />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmkeluhan" name="rmkeluhan" placeholder="keluhan" readonly>{{$rekam->rmkeluhan}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmpemeriksaan" name="rmpemeriksaan" placeholder="pemeriksaan" readonly>{{$rekam->rmpemeriksaan}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmterapi" name="rmterapi" placeholder="terapi" readonly>{{$rekam->rmterapi}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmalergiobat" name="rmalergiobat" placeholder="alergi obat" readonly>{{$rekam->rmalergiobat}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmresep" name="rmresep" placeholder="resep" readonly>{{$rekam->rmresep}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea class="form-control" id="rmkesimpulan" name="rmkesimpulan" placeholder="kesimpulan" readonly>{{$rekam->rmkesimpulan}}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label" style="text-align:left;">&emsp;Kondisi Pasien Keluar</label>
									<div class="col-sm-5">
										<select name="kondisi_pasien" class="form-control select2" id="kondisi_pasien" required data-placeholder="Kondisi Pasien Keluar..." disabled>
											<option></option>

...
@endif
<div class="row">
	<form role="form" action="{{route('pengaturan.honor.save')}}" method="post">
		@csrf
	<div class="col-md-12">
					...
					<div class="panel-body">
						<div class="form-horizontal form-groups-bordered">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="category" name="category" placeholder="nama kategori" value="{{ old('petugas') }}" required readonly/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="petugas" name="petugas" placeholder="nama petugas" value="{{ old('petugas') }}" required readonly/>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control numbers" id="honor" name="honor" value="0" autocomplete="off" required />
								</div>
							</div>
						</div>
					</div>

jQuery(document).ready(function($) {
  ...
  $('#save_pesanan2').click(function(e) {
  	...
  	var html_tabel = '<tr class="gradeU"><td>'+no_pesanan2+'</td><td>'+$("#uraian_pesanan2 option:selected").html()+'</td><td>'+volume_kontrak2.val()+'</td><td>'+harga_satuan2.val()+'</td><td>'+jumlah_harga2.val()+'</td><td>'+ppn2.val()+'</td><td>'+nilai_kontrak2.val()+'</td><td><a class="btn btn-primary btn-sm btn-icon icon-left edit__tabel" data-id="'+no_pesanan2+'" href=""><i class="entypo-eye" ></i>Edit</a></td></tr>';
  ...
  $('#ppn2').change(function() {
      ...
      console.log(ppn2, jumlah_harga2)
  ...
  $(document).on('click', '.remove__table', function(e) {
    ...
    // console.log(id,$('#countPesanan').find('[data-id='+id+']'));
